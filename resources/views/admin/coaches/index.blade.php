...
@section('titlePage') coachs page @endsection
                  ...
                  <div class="card-body table-responsive p-0">
                    ...
                    @endphp
                        ...
                        <tr>
                           ...
                           <td><a  class="edit-btn" id="3" href="{{route('admin.coaches.edit',$coach->id)}}">Edit</a> 
                            <form style="display:inline;" action="{{route('admin.coaches.destroy',$coach->id)}}" method="POST">
                                @csrf
                                @method('DELETE')
                  ...
                  <form action="{{route('admin.add_coaches.store')}}" method="POST">
                    ...
                    <div>
                       <label for="">Password</label>
                        ...
                        <input name="availability" type="text" class="inputpopup" placeholder=" Enter availability">
