                  ...
                  <div class="card-body table-responsive p-0">
                    ...
                    @endphp
                        ...
                        <tr>
                            ...
                            {{-- <td>{{$class->class_Schedual}}</td> --}}
                            
                            {{-- <td> $ {{$class->time}}</td> --}}
                            {{-- <td>{{$class->trainer}}</td> --}}
                           <td><a  class="edit-btn"  href="{{route('admin.plan.edit',$class->id)}}">Edit</a> 
                            <form style="display:inline;" action="{{route('admin.plan.destroy',$class->id)}}" method="POST">
                                @csrf
                                @method('DELETE')
                        ...
                        <div class="popup-cuntentmm">
                          ...
                          <form action="{{route('admin.classes.store')}}"method="POST">
                            ...
                            <div>
                                ...
                                <input name="class_Name" type="text" class="inputpopup" placeholder=" name ">
                                <label for="">Class Date</label>
                                <input name="class_date" type="date" class="inputpopup" >
        
                            </div>
                            <div>
                                <label for="">Time</label>
                                <input name="time" type="time" class="inputpopup">
                                <label for="">Trainer</label>
                                <input name="trainer" type="text" class="inputpopup" >
                                <div>
                                  <br>
                                  <button type="submit" class="edit-btn">Add class</button>
