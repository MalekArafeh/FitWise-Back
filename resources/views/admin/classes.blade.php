...
<head>
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="{{url('admin/plugins/fullcalendar/main.css')}}">
  <!-- Theme style -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Classes Page</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="sticky-top mb-3">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Create Event test</h3>
                </div>
                <div class="card-body">
