  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Active Coaches</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Active Coaches</li>
            </ol>
                    ...
                    <table class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>29</td>
                          <td>0774475777</td>
                          <td>A trainer specialized in bodybuilding</td>
                          <td> bodybuilding</td>
                ...
                <div class="popup-cuntentmm">
                  ...
                  <form action="">
                    ...
                    <div>
                        ...
                        <input type="text" class="inputpopup" placeholder=" Enter coach name">
                        <label for="">Phone number</label>
                        <input type="text" class="inputpopup" placeholder=" Enter phone number">
                        <label for="">Age</label>
                        <input type="text" class="inputpopup" placeholder=" Enter Age">

                    </div>
                    <div>
                        <label for="">Description</label>
                        <input type="text" class="inputpopup" placeholder=" Enter Description">
                        <label for="">expert</label>
                        <input type="text" class="inputpopup" placeholder=" Enter expert">
                        <label for="">picture</label>
                        <input type="file" class="inputpopup" >
