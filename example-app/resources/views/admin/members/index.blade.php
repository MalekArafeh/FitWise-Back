                    ...
                    <table class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
                           ...
                           <td><a  class="edit-btn" id="3" href="{{route('admin.members.edit', $member)}}">Edit</a> <button class="edit-btn1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
